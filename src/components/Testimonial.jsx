        ...
        <div className="flex flex-wrap justify-center">
            {testimonials.map((testimonials, index) => (
                <div key={index} className="w-full sm:w-1/2 lg:w-1/3 px-4 py-2">
                    <div className="bg-white dark:bg-neutral rounded-md p-6 text-md border border-gray-300 dark:border-neutral-800 text-thin">
                        <p className="text-gray-700 dark:text-neutral-300">{testimonials.text}</p>
